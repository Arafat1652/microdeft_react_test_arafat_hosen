...
const Footer = () => {
    return (
        ...
        <footer>
    <div className="bg-gray-800 py-4 text-gray-400 mt-24">
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="flex px-4 my-4 w-full xl:w-1/5 gap-4">
            <img className="w-12 h-12" src="https://static.tacdn.com/img2/brand_refresh/Tripadvisor_logoset_solid_green.svg" alt="" srcSet="" />
            <h3 className="text-2xl text-orange-2 font-bold">MicroDeftTest</h3>
